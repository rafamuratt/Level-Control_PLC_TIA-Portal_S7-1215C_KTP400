...
* Analog Level Monitoring: Reads a Level Indicating Transmitter (LIT) signal (0–27648 analog range) with built-in safety clamping to guard against out-of-range values.  
...
* HMI Integration: All key process variables (level, motor power, status indicators) are mirrored to HMI tags for live operator visibility.     
...
* Level Sensor: Analog Level Indicating Transmitter (LIT) 0-10V, 0–27648 range  
* Frequency Inverter  
* AC motor pump     
